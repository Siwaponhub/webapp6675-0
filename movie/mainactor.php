...
<head>
    ...
    <title>Actor Bio</title>
</head>

<body>
    <div class="container">
        <h1>Actor</h1><br>
        <a class="btn btn-success" href='mainmactor.php'>Actor</a>
                ...
                <?php
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr><td>".$row["Actor_ID"]."</td>"."<td>".$row["Actor_name"]." ".$row["Actor_lastname"]."</td>"."<td>".$row["Actor_age"]."</td>"."<td>".$row["Product_name"]."</td>"."<td>"."<a class='btn btn-warning' href='editactor.php?Actor_ID=".$row["Actor_ID"]."'>Edit</a>"."</td>";
                            echo "</tr>";    
                        }
                    }else {
                        echo "0 results";
